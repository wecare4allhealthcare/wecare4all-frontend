...
function CancelAppointmentModal({ appt, onConfirm, onClose }) {
...
// ── EDIT DOCTOR (full profile + availability) ────────────────
...
function EditDoctorModal({ doctorId, onClose, onSaved }) {
  const token = localStorage.getItem("wc4a_token");
...
function EmpanelmentFullDetails({ e }){
