...
.ad-content{margin-left:220px;padding:24px;}
.nav-item{
...
/* Cards */
.stat-card{background:#fff;border:1px solid #e2eaf4;border-radius:14px;padding:20px;
  transition:all .25s;box-shadow:0 2px 8px rgba(11,31,58,.05);}
.stat-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(11,31,58,.10);}
...
.btn-sm{padding:6px 14px;border-radius:7px;border:none;cursor:pointer;
...
.fchip{padding:7px 15px;border-radius:50px;border:1.5px solid #e2eaf4;
...
@media(max-width:860px){
  .ad-sidebar{width:60px;}
  .nav-label{display:none!important;}
  .ad-content{margin-left:60px;}
}
`;
  ...
  return (
    <div className="ad">
      ...
      <div className="ad-sidebar">
        ...
        {/* Bottom */}
        <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"14px 16px",borderTop:"1px solid rgba(255,255,255,.08)"}}>
          <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:"12px",color:"rgba(255,255,255,.45)",marginBottom:"8px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
            {user?.name||user?.email||"Admin"}
          </p>
          <button onClick={()=>{logout();navigate("/");}}
            style={{width:"100%",padding:"8px",borderRadius:"8px",background:"rgba(220,38,38,.15)",border:"1px solid rgba(220,38,38,.25)",color:"#fca5a5",fontFamily:"'DM Sans',sans-serif",fontSize:"12px",cursor:"pointer"}}>
            Logout
          </button>
        </div>
      </div>
