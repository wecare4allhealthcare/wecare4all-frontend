...
export default function Dashboard() {
  ...
  const C = { patient:"#047857", doctor:"#0369a1", admin:"#7c3aed" }["patient"];
  const I = { patient:"👋", doctor:"👨‍⚕️", admin:"⚙️" }["patient"];
  const R = { patient:"Phase 2 — Doctor listing, appointments, patient profile", doctor:"Phase 4 — Appointment management, video consultation", admin:"Phase 3 — Doctor management, analytics dashboard" }["patient"];
  return (
    <div style={{minHeight:"100vh",background:"#f0f6fc",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px"}}>
      <div style={{background:"#fff",border:"1px solid #e2eaf4",borderRadius:"20px",padding:"48px 40px",textAlign:"center",maxWidth:"500px",width:"100%",boxShadow:"0 4px 20px rgba(11,31,58,.08)"}}>
        ...
        <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:"15px",color:"#64748b",margin:"0 0 16px"}}>You are logged in as <strong style={{textTransform:"capitalize"}}>patient</strong>.</p>
