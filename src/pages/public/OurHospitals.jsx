  ...
  return (
    <div className="oh" style={{background:"#f8faff",minHeight:"100vh"}}>
      ...
      <div className="oh-hero" style={{background:"linear-gradient(135deg,var(--wc-navy) 0%,#112d52 60%,#0a2840 100%)",
        ...
        {/* Sticky below the 72px navbar. (Aug 2026: was temporarily
            108px while a top contact strip existed above the navbar —
            removed in favor of a floating call button, see
            CallFloatButton.jsx, so this is back to 72px.) */}
