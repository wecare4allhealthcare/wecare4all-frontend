/**
 * Blog.jsx — We Care 4 'all'
 * Uses CommonNinja Blog widget (same as PHP project)
 * Widget: pid-b301ce56-e66f-4ea3-8b22-abc819ea0d68
 */
...
/* Make CommonNinja widget responsive */
.commonninja_component { width:100% !important; }
`;

const W = ({ children, s = {} }) => (
  <div style={{ maxWidth:"1200px", margin:"0 auto", padding:"0 24px", ...s }}>
    {children}
  </div>
);
...
export default function Blog() {
  useEffect(() => {
    document.title = "Blog — We Care 4 'all'";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="bl">
        ...
        <W s={{ padding:"52px 24px 80px" }}>
          ...
          <div style={{ display:"flex", gap:"8px", alignItems:"center", marginBottom:"20px" }}>
            ...
            <span style={{ color:"#6ee7b7", fontSize:"13px",
              fontFamily:"'DM Sans',sans-serif" }}>Blog</span>
          </div>

          <p style={{
            fontFamily:"'DM Sans',sans-serif", fontSize:"11px", fontWeight:"700",
            color:"#6ee7b7", letterSpacing:"2px", textTransform:"uppercase",
            marginBottom:"14px",
          }}>Healthcare Insights</p>
          ...
          <h1 style={{
            ...
            Latest Articles &<br />
            <span style={{ color:"#34d399" }}>Health Guides.</span>
          </h1>

          <p style={{
            fontFamily:"'DM Sans',sans-serif", fontSize:"17px",
            color:"rgba(255,255,255,.68)", lineHeight:"1.78",
            maxWidth:"490px", fontWeight:"300",
          }}>
            Expert insights on healthcare, hospital management,
            patient care and medical tourism — from our team.
          </p>
        </W>
      ...
      <section style={{ background:"#f0f6fc", padding:"60px 0 80px" }}>
        <W>
          {/* CommonNinja Blog Widget — same as PHP project */}
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            color:"rgba(255,255,255,.65)", marginBottom:"24px",
          }}>
            Our specialists are available for video consultations and home visits.
          </p>
          <div style={{ display:"flex", gap:"12px", justifyContent:"center", flexWrap:"wrap" }}>
            <Link to="/login" style={{
              ...
              boxShadow:"0 4px 18px rgba(4,120,87,.38)",
            }}>
              Book Consultation →
            </Link>
            <Link to="/contact" style={{
              ...
              color:"#fff", fontFamily:"'DM Sans',sans-serif",
              fontWeight:"500", fontSize:"15px", padding:"13px 26px",
              borderRadius:"8px", textDecoration:"none",
            }}>
              Contact Us
            </Link>
