  ...
  return(
    <div className="hp">
      ...
      <section style={{background:"linear-gradient(135deg,var(--wc-navy-deepest),var(--wc-navy) 60%,var(--wc-navy-deep))",paddingTop:"40px",position:"relative",overflow:"hidden"}}>
        ...
        <W s={{padding:"52px 24px 80px"}}>
          <div style={{display:"flex",gap:"8px",alignItems:"center",marginBottom:"20px"}}>
            <Link to="/" style={{color:"rgba(255,255,255,.5)",fontSize:"13px",fontFamily:"'Inter',sans-serif"}}>{t("common.home")}</Link>
            <span style={{color:"rgba(255,255,255,.25)"}}>/</span>
            <span style={{color:"var(--wc-green-pale)",fontSize:"13px",fontFamily:"'Inter',sans-serif"}}>{t("hp.breadcrumb")}</span>
          </div>
          <p style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",fontWeight:"700",color:"var(--wc-green-pale)",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"14px"}}>{t("hp.eyebrow")}</p>
          <h1 style={{fontFamily:"'Manrope',sans-serif",fontSize:"clamp(34px,5vw,58px)",fontWeight:"700",color:"#fff",lineHeight:"1.1",marginBottom:"16px"}}>
            {t("hp.title1")}<br/><span style={{color:"var(--wc-green-lighter)"}}>{t("hp.title2")}</span>
          </h1>
          <p style={{fontFamily:"'Inter',sans-serif",fontSize:"17px",color:"rgba(255,255,255,.68)",lineHeight:"1.78",maxWidth:"500px",fontWeight:"300",marginBottom:"28px"}}>
            {t("hp.subtitle")}
          </p>
      ...
      <section style={{background:"#f0f6fc",padding:"72px 0"}}>
        <W>
          <div style={{textAlign:"center",marginBottom:"44px"}}>
            <p style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",fontWeight:"700",color:"var(--wc-green)",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"10px"}}>{t("hp.core.eyebrow")}</p>
          ...
          <div ref={r1} className={`g2-svc stagger${v1?" in":""}`} style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(0,1fr)",gap:"22px"}}>
            {SVCS.map(({ic,t:title,c,bg,bd,desc,link})=>(
              <div key={title} className="svc-card" style={{background:bg,border:`1px solid ${bd}`,borderLeft:`4px solid ${c}`,borderRadius:"14px",padding:"26px 22px",boxShadow:"0 2px 10px rgba(18,59,74,.05)",minWidth:0,overflow:"hidden"}}>
                ...
                <p style={{fontFamily:"'Inter',sans-serif",fontSize:"14px",color:"var(--wc-muted)",lineHeight:"1.72",margin:"0 0 14px",fontWeight:"300",overflowWrap:"break-word",wordBreak:"break-word"}}>{desc}</p>
                ...
                <button
                  ...
                  style={{fontFamily:"'Inter',sans-serif",fontSize:"13px",fontWeight:"600",color:c,background:"none",border:"none",cursor:"pointer",padding:0}}>{t("hp.bookNow")}</button>
              </div>
            ))}
          </div>
        </W>
      ...
      <section style={{background:"#fff",padding:"72px 0"}}>
        <W>
          <div style={{textAlign:"center",marginBottom:"44px"}}>
            <p style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",fontWeight:"700",color:"var(--wc-green)",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"10px"}}>{t("hp.specs.eyebrow")}</p>
      ...
      <section style={{background:"linear-gradient(135deg,var(--wc-navy),var(--wc-navy-mid))",padding:"88px 0"}}>
        <W>
          <div style={{textAlign:"center",maxWidth:"640px",margin:"0 auto 48px"}}>
            ...
            <p style={{fontFamily:"'Inter',sans-serif",fontSize:"15.5px",color:"rgba(255,255,255,.68)",lineHeight:"1.78",fontWeight:"300"}}>{t("hp.home.subtitle")}</p>
          </div>
          ...
          <div ref={r3} className={`reveal${v3?" in":""}`}
            ...
            {PRICING.map(([ic,svc,desc])=>(
              <div key={svc}
                ...
                <h3 style={{fontFamily:"'Inter',sans-serif",fontSize:"15.5px",fontWeight:"700",
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(min(220px,100%),1fr))",gap:"18px",marginBottom:"40px"}}>
            {STEPS.map(([n,title,d])=>(
              <div key={n} style={{padding:"22px 18px",background:"rgba(255,255,255,.05)",
                ...
                <span style={{fontFamily:"'Manrope',sans-serif",fontSize:"30px",
                  fontWeight:"700",color:"var(--wc-green-lighter)",display:"block",marginBottom:"8px",lineHeight:1}}>{n}</span>
                <p style={{fontFamily:"'Inter',sans-serif",fontWeight:"700",color:"#fff",
